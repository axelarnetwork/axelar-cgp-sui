module governance::governance {
    ...
    use sui::{address, hex, package::{Self, UpgradeCap, UpgradeTicket, UpgradeReceipt}, table::{Self, Table}};
    ...
    public fun is_governance(self: &Governance, chain_name: String, addr: String): bool {
        &chain_name ==
    ...
    fun test_is_governance() {
        ...
        assert!(governance.is_governance(trusted_source_chain, trusted_source_address), EUntrustedAddress);
    ...
    fun test_authorize_upgrade() {
        ...
        assert!(package::ticket_package(&upgrade_ticket) == object::uid_to_inner(&uid), EUntrustedAddress);
        let policy = abi.read_u8();
