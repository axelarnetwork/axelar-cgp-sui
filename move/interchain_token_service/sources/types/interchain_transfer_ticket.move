module interchain_token_service::interchain_transfer_ticket {
    ...
    public(package) fun destroy<T>(self: InterchainTransferTicket<T>): (TokenId, Balance<T>, address, String, vector<u8>, vector<u8>, u64) {
        ...
        (token_id, balance, source_address, destination_chain, destination_address, metadata, version)
    }
}
