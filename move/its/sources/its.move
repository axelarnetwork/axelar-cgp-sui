...
fun test_register_coin() {
    ...
    utils::assert_assert_single_event<its::events::CoinRegistered<COIN>>();
...
fun test_deploy_remote_interchain_token() {
    ...
    utils::assert_assert_single_event<its::events::InterchainTokenDeploymentStarted<COIN>>();
...
fun test_deploy_interchain_token() {
    ...
    utils::assert_assert_single_event<its::events::InterchainTransfer<COIN>>();
...
fun test_receive_interchain_transfer() {
    ...
    utils::assert_assert_single_event<its::events::InterchainTransferReceived<COIN>>();
