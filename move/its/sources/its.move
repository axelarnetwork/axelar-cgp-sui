...
#[test_only]
public fun test_add_unregistered_coin_type(
    self: &mut ITS,
    token_id: UnregisteredTokenId,
    type_name: TypeName,
) {
...
#[test_only]
public fun test_remove_unregistered_coin_type(
    self: &mut ITS,
    token_id: UnregisteredTokenId,
): TypeName {
...
#[test_only]
public fun test_add_registered_coin_type(
    self: &mut ITS,
    token_id: TokenId,
    type_name: TypeName,
) {
...
#[test_only]
public fun test_remove_registered_coin_type(
    self: &mut ITS,
    token_id: TokenId,
): TypeName {
