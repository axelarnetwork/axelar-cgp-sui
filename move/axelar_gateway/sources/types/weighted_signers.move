module axelar_gateway::weighted_signers {
    use axelar_gateway::{bytes32::{Self, Bytes32}, weighted_signer::{Self, WeightedSigner}};
    use sui::{bcs::{Self, BCS}, hash};
    ...
    #[test_only]
    public fun create_for_testing(signers: vector<WeightedSigner>, threshold: u128, nonce: Bytes32): WeightedSigners {
        WeightedSigners {
            signers,
            threshold,
            nonce,
