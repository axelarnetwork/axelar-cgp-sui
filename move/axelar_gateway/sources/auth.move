module axelar_gateway::auth {
    use axelar_gateway::{bytes32::{Self, Bytes32}, events, proof::Proof, weighted_signers::WeightedSigners};
    use sui::{bcs, clock::Clock, table::{Self, Table}};
    ...
    #[test_only]
    public(package) fun new_message_to_sign(domain_separator: Bytes32, signers_hash: Bytes32, data_hash: Bytes32): MessageToSign {
        MessageToSign {
            domain_separator,
            signers_hash,
            data_hash,
    ...
    #[test_only]
    public fun destroy_for_testing(signers: AxelarSigners): (u64, Table<Bytes32, u64>, Bytes32, u64, u64, u64) {
        let AxelarSigners {
            epoch,
        ...
        (epoch, epoch_by_signers_hash, domain_separator, minimum_rotation_delay, last_rotation_timestamp, previous_signers_retention)
    }
