module operators::operators {
    ...
    use sui::{bag::{Self, Bag}, event, vec_set::{Self, VecSet}};
    ...
    public fun loan_cap<T: key + store>(self: &mut Operators, _operator_cap: &OperatorCap, cap_id: ID, ctx: &mut TxContext): (T, Borrow) {
    ...
    /// loaned capability.
    public fun restore_cap<T: key + store>(self: &mut Operators, _operator_cap: &OperatorCap, cap: T, borrow_obj: Borrow) {
        let cap_id = object::id(&cap);
