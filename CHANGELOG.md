...
- 1ece033: 0137059: Added support for coin deployers to manage and reclaim their coin's `TreasuryCap`
- fdb0106: Added the ability to register custom tokens
- 1ece033: 6721872: Retired ITS `register_coin` and replaced it with new functions `register_coin_from_info` and `register_coin_from_metadata`
...
- 1ece033: 6007ce9: `CoinInfo` field `metadata` is deprecated and will always be `Option::none`
- 1ece033: 6007ce9: Added function to migrate coin metadata saved in ITS to a publicly shared object (e.g. to display correctly in wallets)
